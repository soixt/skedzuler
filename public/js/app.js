...
/* harmony import */ var _Calendar_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Calendar.vue */ "./resources/js/components/Calendar.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    'calendar': _Calendar_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
    'loader': _Loader_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])(['setAuthToken', 'setAuthUser'])), {}, {
    login: function login() {
      ...
      axios.post('http://127.0.0.1:8000/api/login', {
        ...
        _this.setAuthToken('Bearer ' + response.data.access_token);

        _this.getUser('Bearer ' + response.data.access_token);
      })["catch"](function (error) {
        _this.loginForm.error = error.response.data.message;
      });
    },
    register: function register() {
      ...
      axios.post('http://127.0.0.1:8000/api/register', {
        ...
        _this2.registerForm.username = '';
        _this2.registerForm.password = '';
      })["catch"](function (error) {
        _this2.registerForm.errors = error.response.data.errors;
      });
    },
    logout: function logout() {
      ...
      axios.post('http://127.0.0.1:8000/api/logout', {}, {
        ...
        _this3.setAuthToken(null);

        _this3.setAuthUser(null);
    ...
    getUser: function getUser(token) {
      ...
      axios.post('http://127.0.0.1:8000/api/me', {}, {
        ...
        _this4.setAuthUser(response.data);
      })["catch"](function (error) {
        alert('Something went wrong!');
      });
    }
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])(['getAuth', 'isLoggedIn', 'loading']))
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    navigate: function navigate(direction) {
      var month = this.monthAsString;
      var year = this.currentDate.year;
      var index = this.monthNames.findIndex(function (m) {
        return m == month;
      });
      ...
      this.getEvents(new Date("01 ".concat(month, " ").concat(year)));
    },
    getLeadingDays: function getLeadingDays(date) {
      var ret = [];
      var year = date.getFullYear();
      var month = date.getMonth();
      var firstWeekday = new Date(year, month, 0).getDay();
      var days = firstWeekday + 7 - 7 - 1;
    ...
    getMonthDays: function getMonthDays(date, events) {
      var ret = [];
      var year = date.getFullYear();
      var month = date.getMonth();
    ...
    getTrailingDays: function getTrailingDays(leadingDays, monthDays) {
      var ret = [];
      var totaldays = leadingDays.length >= 5 ? 42 : 35;
      var days = totaldays - (leadingDays.length + monthDays.length);
    ...
    showCalendar: function showCalendar(date, events) {
    ...
    addEventForm: function addEventForm(day) {
      this.currentDate.day = day;
      this.modal = 'add-event';
    },
    updateEventForm: function updateEventForm(event) {
    ...
    addEvent: function addEvent() {
      ...
      if (this.newEventForm.description == "") {
        alert('Description cannot be empty!');
        return;
      }

      axios.post('http://127.0.0.1:8000/api/schedule', {
        date: "".concat(this.currentDate.day, "/").concat(this.currentDate.month, "/").concat(this.currentDate.year),
        ...
        _this.calendarDays.currentMonthDays.forEach(function (date) {
          if (date.day == _this.currentDate.day) {
        ...
        _this.newEventForm.errors = error.response.data.errors;
      });
    },
    updateEvent: function updateEvent() {
      var _this2 = this;

      if (this.editEventForm.description == "") {
        alert('Description cannot be empty!');
        return;
      }
      ...
      axios.post('http://127.0.0.1:8000/api/schedule/edit', {
        ...
        _this2.calendarDays.currentMonthDays.forEach(function (date) {
        ...
        _this2.modal = 'show-event';
      })["catch"](function (error) {
        _this2.editEventForm.errors = error.response.data.errors;
      });
    },
    deleteEvent: function deleteEvent(id) {
      ...
      axios.post('http://127.0.0.1:8000/api/schedule/delete', {
        ...
        _this3.calendarDays.currentMonthDays.forEach(function (date) {
          if (date.id == id) {
            date.event = null;
          }
        });
    ...
    getEvents: function getEvents(date) {
      ...
      axios.post('http://127.0.0.1:8000/api/schedules', {
        ...
        _this4.showCalendar(date, response.data.data);
      });
    }
  },
  mounted: function mounted() {
  ...
  computed: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])(['getAuth'])), {}, {
    monthAsString: function monthAsString() {
      return this.monthNames[this.currentDate.month - 1];
    },
    showCalendarDays: function showCalendarDays() {
      return [].concat(_toConsumableArray(this.calendarDays.prevMonthDays), _toConsumableArray(this.calendarDays.currentMonthDays), _toConsumableArray(this.calendarDays.nextMonthDays));
    }
  })
});
...
/*!**************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Calendar.vue?vue&type=style&index=0&id=052a41a9&scoped=true&lang=css& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n*[data-v-052a41a9] {\n    box-sizing: border-box;\n}\n.textarea[data-v-052a41a9] {\n    resize: none\n}\n.title[data-v-052a41a9] {font-size: 2rem;}\n.calendar[data-v-052a41a9] {width: calc(100% - 100px); padding: 50px; text-align: center}\n.calendar .week-days b[data-v-052a41a9],\n.calendar .days button[data-v-052a41a9] { \n  display: block;\n  float: left;\n  width: calc(100% / 7);\n  height: 50px;\n}\n.new-event[data-v-052a41a9] {\n    width: 400px;\n    background-color: #fff;\n    padding: 15px;\n    text-align: center;\n    border-radius: 5px;\n    position: fixed;\n    top: 50px;\n    left: calc(50% - 200px);\n    overflow-x: hidden;\n}\n", ""]);
...
// module
exports.push([module.i, "\n.loading[data-v-e79ec684] {\n    background-color:#2980b9;\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100vw;\n    height: 100vh;\n    padding: calc(50vh - 30px) 0;\n    text-align: center;\n    color: #fff;\n}\n.sk-folding-cube[data-v-e79ec684] {\n    margin: 20px auto;\n    width: 40px;\n    height: 40px;\n    position: relative;\n    transform: rotateZ(45deg);\n}\n.sk-folding-cube .sk-cube[data-v-e79ec684] {\n  float: left;\n  width: 50%;\n  height: 50%;\n  position: relative;\n  transform: scale(1.1);\n}\n.sk-folding-cube .sk-cube[data-v-e79ec684]:before {\n  content: '';\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: #333;\n  -webkit-animation: sk-foldCubeAngle-data-v-e79ec684 2.4s infinite linear both;\n          animation: sk-foldCubeAngle-data-v-e79ec684 2.4s infinite linear both;\n  transform-origin: 100% 100%;\n}\n.sk-folding-cube .sk-cube2[data-v-e79ec684] {\n  transform: scale(1.1) rotateZ(90deg);\n}\n.sk-folding-cube .sk-cube3[data-v-e79ec684] {\n  transform: scale(1.1) rotateZ(180deg);\n}\n.sk-folding-cube .sk-cube4[data-v-e79ec684] {\n  transform: scale(1.1) rotateZ(270deg);\n}\n.sk-folding-cube .sk-cube2[data-v-e79ec684]:before {\n  -webkit-animation-delay: 0.3s;\n          animation-delay: 0.3s;\n}\n.sk-folding-cube .sk-cube3[data-v-e79ec684]:before {\n  -webkit-animation-delay: 0.6s;\n          animation-delay: 0.6s;\n}\n.sk-folding-cube .sk-cube4[data-v-e79ec684]:before {\n  -webkit-animation-delay: 0.9s;\n          animation-delay: 0.9s;\n}\n@-webkit-keyframes sk-foldCubeAngle-data-v-e79ec684 {\n0%, 10% {\n    transform: perspective(140px) rotateX(-180deg);\n    opacity: 0;\n}\n25%, 75% {\n    transform: perspective(140px) rotateX(0deg);\n    opacity: 1;\n}\n90%, 100% {\n    transform: perspective(140px) rotateY(180deg);\n    opacity: 0;\n}\n}\n@keyframes sk-foldCubeAngle-data-v-e79ec684 {\n0%, 10% {\n    transform: perspective(140px) rotateX(-180deg);\n    opacity: 0;\n}\n25%, 75% {\n    transform: perspective(140px) rotateX(0deg);\n    opacity: 1;\n}\n90%, 100% {\n    transform: perspective(140px) rotateY(180deg);\n    opacity: 0;\n}\n}\n", ""]);
...
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Calendar.vue?vue&type=style&index=0&id=052a41a9&scoped=true&lang=css& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--6-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Loader.vue?vue&type=style&index=0&id=e79ec684&scoped=true&lang=css& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
  ...
  return _c(
    ...
    [
        ...
        _c("div", { staticClass: "hero-body" }, [
          _c(
            "div",
            {
              ...
              class: _vm.isLoggedIn ? "has-text-right" : ""
            },
            [
              _c("h1", { staticClass: "title" }, [
                _vm._v(
                  _vm._s(
                    _vm.isLoggedIn
                      ? _vm.getAuth.user.username
                      : "Login to see calendar"
                  )
                )
              ]),
              _vm._v(" "),
      ...
      _c(
        ...
        { staticClass: "container" },
        [
          _vm.isLoggedIn ? _c("calendar") : _vm._e(),
          _vm._v(" "),
          _c("div", { staticClass: "columns pt-3" }, [
            !_vm.isLoggedIn
              ? _c(
                  "div",
                  { staticClass: "column is-4 is-offset-1 has-text-centered" },
                  [
                    _c("h3", { staticClass: "title has-text-black" }, [
                      _vm._v("Login")
                    ]),
                    _vm._v(" "),
                    _c("hr", { staticClass: "login-hr" }),
                    _vm._v(" "),
                    _c("div", { staticClass: "box" }, [
                      _c("form", [
                        _vm.loginForm.error
                          ? _c("p", { staticClass: "help is-danger mb-3" }, [
                              _vm._v(_vm._s(_vm.loginForm.error))
                            ])
                          : _vm._e(),
                        _vm._v(" "),
                    ...
                    _c("div", { staticClass: "box" }, [
                      _c("form", [
                        _c("div", { staticClass: "field" }, [
                          ...
                          _vm._v(" "),
                          _vm.registerForm.errors &&
                          _vm.registerForm.errors.username
                            ? _c("p", { staticClass: "help is-danger" }, [
                                _vm._v(
                                  _vm._s(_vm.registerForm.errors.username[0])
                                )
                              ])
                            : _vm._e()
                        ]),
                        ...
                        _c("div", { staticClass: "field" }, [
                          ...
                          _vm._v(" "),
                          _vm.registerForm.errors &&
                          _vm.registerForm.errors.password
                            ? _c("p", { staticClass: "help is-danger" }, [
                                _vm._v(
                                  _vm._s(_vm.registerForm.errors.password[0])
                                )
                              ])
                            : _vm._e()
                        ]),
...
var render = function() {
  ...
  return _c("div", { staticClass: "calendar" }, [
    _c("div", { staticClass: "title" }, [
      ...
      _vm._v(" "),
      _c("span", { staticClass: "month" }, [_vm._v(_vm._s(_vm.monthAsString))]),
      _vm._v(" "),
      _c("span", { staticClass: "year" }, [
        _vm._v(_vm._s(_vm.currentDate.year))
      ]),
      _vm._v(" "),
      _c(
        "span",
    ...
    _c(
      ...
      _vm._l(_vm.weekDays, function(day, i) {
        return _c("b", { key: i }, [_vm._v(_vm._s(day))])
      }),
      0
    ),
    _vm._v(" "),
    _c(
      ...
      { staticClass: "days" },
      [
        _vm._l(_vm.showCalendarDays, function(c, i) {
          return [
            !c.event
              ? _c(
                  "button",
    ...
    _vm.modal == "add-event"
      ? _c("div", { staticClass: "modal is-active" }, [
          ...
          _c("div", { staticClass: "modal-content" }, [
            _c("div", { staticClass: "modal-card has-text-centered" }, [
                ...
                _c("div", { staticClass: "field" }, [
                  _c("div", { staticClass: "control" }, [
                    _c("textarea", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.newEventForm.description,
                          expression: "newEventForm.description"
                        }
                      ],
                      ...
                      domProps: { value: _vm.newEventForm.description },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                  ...
                  _vm._v(" "),
                  _vm.newEventForm.errors && _vm.newEventForm.errors.description
                    ? _c("p", { staticClass: "help is-danger" }, [
                        _vm._v(_vm._s(_vm.newEventForm.errors.description[0]))
                      ])
                    : _vm._e()
                ]),
                _vm._v(" "),
                ...
                _c("div", { staticClass: "field" }, [
                  _c("div", { staticClass: "control" }, [
                    _c("textarea", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.editEventForm.description,
                          expression: "editEventForm.description"
                        }
                      ],
                      staticClass: "textarea is-primary",
                      attrs: {
                      ...
                      domProps: { value: _vm.editEventForm.description },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                  ...
                  _vm._v(" "),
                  _vm.editEventForm.errors &&
                  _vm.editEventForm.errors.description
                    ? _c("p", { staticClass: "help is-danger" }, [
                        _vm._v(_vm._s(_vm.editEventForm.errors.description[0]))
                      ])
                    : _vm._e()
                ]),
                _vm._v(" "),
    ...
    _vm.modal == "show-event"
      ? _c("div", { staticClass: "modal is-active" }, [
          ...
          _c("div", { staticClass: "modal-content" }, [
            _c("div", { staticClass: "modal-card has-text-centered" }, [
              _c("header", { staticClass: "modal-card-head" }, [
                _c("p", { staticClass: "modal-card-title" }, [_vm._v("Event")]),
                _vm._v(" "),
                _c("button", {
                  staticClass: "delete",
                  attrs: { "aria-label": "close" },
              ...
              _vm._v(" "),
              _c("section", { staticClass: "modal-card-body" }, [
                _c("p", { staticClass: "mb-4 is-size-3" }, [
                  _vm._v(_vm._s(_vm.showEventForm.event))
                ]),
                _vm._v(" "),
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        return _vm.updateEventForm(_vm.showEventForm)
                      }
                    }
                  },
                  [_vm._v("Edit Event")]
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        return _vm.deleteEvent(_vm.showEventForm.id)
                      }
                    }
                  },
                  [_vm._v("Delete Event")]
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_0__["default"].Store({
  ...
  actions: {
    setAuthUser: function setAuthUser(_ref, user) {
      var commit = _ref.commit;
      commit('SET_AUTH_USER', user);
    },
    setAuthToken: function setAuthToken(_ref2, token) {
      var commit = _ref2.commit;
      commit('SET_AUTH_TOKEN', token);
    },
    setLoading: function setLoading(_ref3, load) {
  ...
  mutations: {
    ...
    SET_LOADING: function SET_LOADING(state, load) {
      state.loading = load;
    }
  },
  getters: {
...
var app = new Vue({
  ...
  store: store,
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])(['setAuthToken', 'setAuthUser', 'setLoading'])), {}, {
    appInit: function appInit() {
      var token = localStorage.getItem('scheduler_user_token');
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])(['getAuth'])),
  mounted: function mounted() {
    this.appInit();
  }
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_052a41a9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader!../../../node_modules/css-loader??ref--6-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/vue-loader/lib??vue-loader-options!./Calendar.vue?vue&type=style&index=0&id=052a41a9&scoped=true&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Calendar.vue?vue&type=style&index=0&id=052a41a9&scoped=true&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_052a41a9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_052a41a9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_052a41a9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_052a41a9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Calendar_vue_vue_type_style_index_0_id_052a41a9_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Loader_vue_vue_type_style_index_0_id_e79ec684_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader!../../../node_modules/css-loader??ref--6-1!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--6-2!../../../node_modules/vue-loader/lib??vue-loader-options!./Loader.vue?vue&type=style&index=0&id=e79ec684&scoped=true&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Loader.vue?vue&type=style&index=0&id=e79ec684&scoped=true&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Loader_vue_vue_type_style_index_0_id_e79ec684_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Loader_vue_vue_type_style_index_0_id_e79ec684_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Loader_vue_vue_type_style_index_0_id_e79ec684_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Loader_vue_vue_type_style_index_0_id_e79ec684_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_6_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Loader_vue_vue_type_style_index_0_id_e79ec684_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
__webpack_require__(/*! C:\xampp\htdocs\scheduler\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\scheduler\resources\sass\app.scss */"./resources/sass/app.scss");
